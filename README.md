...
Умение работать с современным фронтенд-стеком
Имею опыт разработки на React, TypeScript и Redux, интеграции с REST API, построения компонентной архитектуры и работы с состоянием приложения.

Ответственный подход к задачам
Довожу фичи до рабочего состояния,, обрабатываю ошибки и думаю о пользовательском опыте.

Коммуникация и работа в команде
Умею задавать вопросы, принимать обратную связь, аргументировать решения и спокойно работать с правками.
